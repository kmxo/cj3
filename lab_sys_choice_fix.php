...
<main class="content">
        ...
        <div class="content text-content content-wrap">
            ...
            <?php renderTitle('Refactoring an Application to avoid a direct reference to the Choice [sys_choice] table', 'Otherwise your end user can see a lot of sys_ids'); ?>

            <p>
                <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;In a recent article we discussed that it is not a good practice to create a reference field to the Choice [sys_choice] table. 
                <br>
...
<br>
            ...
            <p>
                ...
                <br>This article was featured in the <a href="https://www.linkedin.com/pulse/bean-done-dcs-release-creatorcon-content-latte-more-4qj9e/?trackingId=bSZRrN4xRKe%2Bn%2F7SV44GEA%3D%3D" target="_blank">Community Caf&eacute; Newsletter</a>.
      <!--      <br>
                ...
                </br></br><a href="lab.php" target="_self">Back</a>
                </p>
